...
Die folgende Abbildung zeigt das ER-Diagramm der Referenzdatenbank und verdeutlicht Tabellenstruktur, Datentypen sowie bestehende Beziehungen.

![ER-Diagramm der Datengrundlage](media/ER_Diagramm_MS_SSMS.png)

Diese Datenbank bildet den funktionalen Referenzrahmen der Arbeit. Die relationalen Abfragen, Aggregationen, Views sowie räumlichen Operationen, die im Rahmen der Lehrveranstaltung umgesetzt wurden, definieren den Leistungsumfang, den das Zielsystem in SQLite/SpatiaLite reproduzieren soll.
